...
* @see app/Http/Controllers/ProductController.php:20
* @route '/products'
*/
...
* @see app/Http/Controllers/ProductController.php:26
...
* @see app/Http/Controllers/ProductController.php:38
...
* @see app/Http/Controllers/ProductController.php:43
* @route '/products/{product}'
*/
...
* @see app/Http/Controllers/ProductController.php:49
* @route '/products/{product}'
*/
...
/**
* @see \App\Http\Controllers\ProductController::forceDelete
* @see app/Http/Controllers/ProductController.php:0
* @route '/products/{id}/forceDelete'
*/
...
const ProductController = { index, create, store, show, edit, update, destroy, restore, forceDelete }
