...
* @see app/Http/Controllers/CustomerController.php:26
...
* @see app/Http/Controllers/CustomerController.php:91
* @route '/customers/{customer}'
*/
...
* @see app/Http/Controllers/CustomerController.php:106
...
/**
* @see \App\Http\Controllers\CustomerController::forceDelete
* @see app/Http/Controllers/CustomerController.php:119
* @route '/customers/{id}/forceDelete'
*/
...
const CustomerController = { index, create, store, show, edit, update, destroy, restore, forceDelete }
